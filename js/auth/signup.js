...
function validateForm(){
    ...
    const passwordValidated = validatePassword(inputPassword);
    const passwordConfirmationValidated = validateConfirmationPassword(inputPassword, inputValidationPassword)

    if (nomValidated && prenomValidated && emailValidated && passwordValidated && passwordConfirmationValidated) {
